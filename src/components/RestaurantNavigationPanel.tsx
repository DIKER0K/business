      ...
      <Box sx={{
        ...
        >
          <Box sx={{ 
            ...
            alignItems: 'center',
            backgroundColor: location.pathname === '/restaurant_menu' ? '#1d1d1d' : 'transparent',
            borderRadius: '50%',
            padding: location.pathname === '/restaurant_menu' ? '0.8vw' : '0',
            boxShadow: location.pathname === '/restaurant_menu' ? '0 2px 8px rgba(0,0,0,0.1)' : 'none',
            transition: 'all 0.2s ease',
            mb: '0.3vw'
          }}>
            <LunchDiningRoundedIcon sx={{ 
              fontSize: '1.8vw', 
              color: location.pathname === '/restaurant_menu' ? '#fff' : '#1d1d1d'
            }} />
          </Box>
          <Typography variant="body2" sx={{
            fontSize: '1vw',
            color: location.pathname === '/restaurant_menu' ? '#1d1d1d' : '#1d1d1d'
          }}>Меню</Typography>
        </Box>
